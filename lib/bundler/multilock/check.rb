    ...
    class Check
      ...
      def deep_check(lockfile_definition, conflicts: nil)
        ...
        @cache.deep_check(lockfile_name) do
          success = true # rubocop:disable Lint/UselessAssignment -- work around rubocop bug
          ...
          unless parser.platforms == parent_parser.platforms
            ...
            success = false # rubocop:disable Lint/UselessAssignment -- work around rubocop bug
          end
